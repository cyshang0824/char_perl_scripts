...
if ($test eq "all") {
	...
	$datalog_file_leak = "flashio_leak_datalog_${split}_${test_mode}_${date_array[1]}${date_array[2]}.log";
	open fh_leak, ">>$datalog_file_leak";
	print "IO Leak Data will be written to -> $datalog_file_leak\n";
	
	$datalog_file_vilh = "flashio_vilh_datalog_${split}_${test_mode}_${date_array[1]}${date_array[2]}.log";
	open fh_vilh, ">>$datalog_file_vilh";
	print "VILH Data will be written to -> $datalog_file_vilh\n";
	
	$datalog_file_od = "flashio_od_datalog_${split}_${test_mode}_${date_array[1]}${date_array[2]}.log";
	open fh_od, ">>$datalog_file_od";
	print "PVT compensation Output Drive Data will be written to -> $datalog_file_od\n";
	
	$datalog_file_odt = "flashio_odt_datalog_${split}_${test_mode}_${date_array[1]}${date_array[2]}.log";
